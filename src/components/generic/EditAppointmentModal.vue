    ...
    <div class="modal-overlay">
      <div class="modal">
        <div class="modal-content">
          <h2>Agendar consulta para o dia {{ appointment.date }}</h2>
          <form @submit.prevent="saveChanges">
            ...
            <div class="buttons-content">
              ...
              <button class="close-button" @click="closeEditModal">Cancelar</button>
            </div>
          </form>
        </div>
      </div>
...
import Multiselect from '@vueform/multiselect'
  ...
  export default {
    ...
    data() {
      return {
        appointment: this.appointment, // Clone do card para edição
        appointmentDoctor: this.doctorId,
        appointmentPatient: this.patientId,
